...
__C.DATASETS.SHAPENET.PARTIAL_POINTS_PATH        = '/PCN/%s/partial/%s/%s/%02d.pcd'
__C.DATASETS.SHAPENET.COMPLETE_POINTS_PATH       = '/PCN/%s/complete/%s/%s.pcd'
...
__C.DIR                                          = edict()
__C.DIR.OUT_PATH                                 = './exp/c3d'
__C.CONST.DEVICE                                 = '0'
__C.CONST.WEIGHTS                                = '' #'/data1/xp/pmp_jittor/checkpoints/2021-07-07T18:01:01.811422/ckpt-best.pkl' # 'ckpt-best.pth'  # specify a path to run test and inference
